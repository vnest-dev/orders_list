...
if (!isset($frameworkPath) || !is_dir($frameworkPath)) {
    $message = "<h1>Error</h1>\n\n"
        . "<p><strong>The path to yii_temp framework seems to be incorrect.</strong></p>\n"
...
$requirements = array(
    ...
    array(
        ...
        'by' => '<a href="http://www.yiiframework.com/doc-2.0/yii_temp-caching-memcache.html">MemCache</a>',
        'memo' => extension_loaded('memcached') ? 'To use memcached set <a href="http://www.yiiframework.com/doc-2.0/yii_temp-caching-memcache.html#$useMemcached-detail">MemCache::useMemcached</a> to <code>true</code>.' : ''
    ),
    // CAPTCHA:
    array(
        ...
        'mandatory' => false,
        'condition' => $gdOK,
        'by' => '<a href="http://www.yiiframework.com/doc-2.0/yii_temp-captcha-captcha.html">Captcha</a>',
        'memo' => $gdMemo,
    ),
    array(
...
if (!version_compare(phpversion(), '5.5', '>=')) {
    $requirements[] = array(
        ...
        'by' => '<a href="http://www.yiiframework.com/doc-2.0/yii_temp-caching-apccache.html">ApcCache</a>',
    );
}
